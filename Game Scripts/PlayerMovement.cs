...

{
    ...
    public void Update()
    {
        ...
        // uses the turn timer for animator paramenters in void start so you can actually see the turn animations, otherwise it would last for 0.01 of a second or something
        if (turnTimer > 0)
        {
